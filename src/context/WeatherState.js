...
const WeatherState = (props) => {
  ...
  return (
    <WeatherContext.Provider value={{ cityName, setCityName, data, setData, showAlert, setShowAlert, alertMsg, setAlertMsg, getCityWeatherData, showLoader, setShowLoader, base_url, api_key, no_of_days, theme, setTheme }}>
      {props.children}
